...
<!doctype html> <html lang="fr"> <head>
    ...
    <title> Panel BatirPositif</title>
    <link href="../assets/IconeBatirPositif.png" rel="shortcut icon">
...
<header id="nav-desktop">
    ...
    <nav class="fixed-header">
        <div class="site-title visible-title"><a href="index.php"><img src="../assets/LogoBatirPositifT.png"></a></div>
        <ul class="">
